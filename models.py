...
# Many-to-many mapping for textbooks-authors
...
class User(UserMixin, db.Model):
    ...
    def __init__(self, email, password, name=None):
        ...
        self.avatar = f"https://hostedboringavatars.vercel.app/api/beam?name={self.display_name}"  # Default avatars are generated by inputting the user's display name as a seed to the boringavatars API
        self.email = email
